...
const doStartSimulation = async () => {
  ...
  // Reset state first so prior simulation does not affect this run
  resetAllState()
...
const checkPlatformsCompleted = (data) => {
  ...
  // If any platform finished, check all enabled platforms
  // Enabled platform if actions_count > 0 or running was true
