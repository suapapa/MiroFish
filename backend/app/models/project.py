...
Persist project state on the server so the frontend does not pass large payloads between APIs
"""
...
class ProjectManager:
    """Project manager — persistence and retrieval"""
    ...
    def _get_project_files_dir(cls, project_id: str) -> str:
        """Uploaded files directory for a project"""
        return os.path.join(cls._get_project_dir(project_id), 'files')
    
    @classmethod
    def _get_project_text_path(cls, project_id: str) -> str:
        """Extracted text storage path"""
    ...
    def save_file_to_project(cls, project_id: str, file_storage, original_filename: str) -> Dict[str, str]:
        """
        Save uploaded file into project directory
