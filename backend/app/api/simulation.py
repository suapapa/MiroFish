...
def get_prepare_status():
    ...
    try:
        ...
        if simulation_id:
            ...
            # 未传 task_id 时，尝试从 simulation 状态或活跃任务中恢复
            if not task_id:
                state = manager.get_simulation(simulation_id)
